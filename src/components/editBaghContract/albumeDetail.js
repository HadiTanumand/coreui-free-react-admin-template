          ...
          return (
            <>
              <CCard className="mb-4">
                ...
                <CCardBody>
                  <CForm className="row g-3 needs-validation">
                    <CCol md={4}>
                      ...
                      <CFormSelect
                        onChange={(e)=>handleInput(e,albume.id)}
                        name="type_id"
                ...
                {(albumePaperList[index] && albumePaperList[index].albume_detail_id && albumePaperList[index].albume_detail_id== albume.id) ?
                      ...
                      <CCardBody className="m-2 mb-3  border rounded bg-light">
                        <CForm className="row g-3 needs-validation">
                          <CCol md={4}>
                            ...
                            <CFormSelect
                               onChange={(e)=>handleInputPaper(e,paper.id)}
                              name="paper_type_id"
