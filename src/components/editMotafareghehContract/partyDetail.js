          ...
          <CCardBody>
            <CForm className="row g-3 needs-validation">
              ...
              <CCol md={6} className="mt-5">
                ...
                <DatePicker
                  value={formdata.celebration_date ? formdata.celebration_date : ''}
                  calendar={persian}
                  locale={persian_fa}
                ...
                />
                <span className="ms-4" style={{ fontSize: '25px' }}>
                  {formdata.celebration_time}
                </span>
              </CCol>
            ...
            <CButton color="primary" type="submit" className="mt-4" onClick={updateContract}>
               ویرایش
            </CButton>
            <CButton
              color="danger"
